...
namespace Mirror
{
    ...
    /// </remarks>
    [AddComponentMenu("Network/Network Room Manager Custom")]
    [HelpURL("https://mirror-networking.gitbook.io/docs/components/network-room-manager")]
    public class NetworkRoomManagerCustom : NetworkManager
    {
        ...
        public NetworkRoomPlayerCustom roomPlayerPrefab;
        ...
        public List<NetworkRoomPlayerCustom> roomSlots = new List<NetworkRoomPlayerCustom>();
        public List<LobbyPlayerStats> spawnedRoomPlayers;

        public LobbyPlayerStats GetEmplyLobbyPlayerStats()
        {
            return spawnedRoomPlayers.Find(x => x.nrpc == null);
        }

        public override void Start()
        {
            base.Start();
            NetworkServer.RegisterHandler<steamIdMess>(OnGetSteamIdMess);
        }
        ...
        {
            OnRoomClientEnter();
            foreach (NetworkRoomPlayerCustom player in roomSlots)
                if (player != null)
                {
        ...
        public void CheckReadyToBegin()
        {
            ...
            int numberOfReadyPlayers = NetworkServer.connections.Count(conn =>
                ...
                conn.Value.identity.TryGetComponent(out NetworkRoomPlayerCustom nrp) &&
                nrp.readyToBegin);
        ...
        public override void OnServerDisconnect(NetworkConnectionToClient conn)
        {
            ...
            {
                NetworkRoomPlayerCustom roomPlayer = conn.identity.GetComponent<NetworkRoomPlayerCustom>();
                ...
                {
                    roomPlayer = clientOwnedObject.GetComponent<NetworkRoomPlayerCustom>();
                    if (roomPlayer != null)
                        roomSlots.Remove(roomPlayer);
                }
            }
            ...
            {
                if (player != null)
                    player.GetComponent<NetworkRoomPlayerCustom>().readyToBegin = false;
            }
        ...
        public override void OnServerReady(NetworkConnectionToClient conn)
        {
            ...
            if (conn != null && conn.identity != null)
            {
                ...
                if (roomPlayer != null && roomPlayer.GetComponent<NetworkRoomPlayerCustom>() != null)
        ...
        public override void OnServerAddPlayer(NetworkConnectionToClient conn)
        {
            ...
            if (Utils.IsSceneActive(RoomScene))
            {
                ...
                newRoomGameObject.GetComponent<NetworkRoomPlayerCustom>().netconnid = conn.connectionId;
            }
            else
            {
        ...
        public override void ServerChangeScene(string newSceneName)
        {
            ...
            {
                foreach (NetworkRoomPlayerCustom roomPlayer in roomSlots)
                {
                    if (roomPlayer == null)
                        continue;
                    ...
                    if (NetworkServer.active)
                    {
                        ...
                        roomPlayer.GetComponent<NetworkRoomPlayerCustom>().readyToBegin = false;
        ...
        public void OnGetSteamIdMess(NetworkConnectionToClient nctc, steamIdMess sidm)
        {
            NetworkRoomPlayerCustom nrpc = roomSlots.Find(x=>x.connectionToClient.connectionId==nctc.connectionId);
            if(nrpc!=null)
                nrpc.steamId = sidm.id.ToString();
        }
        ...
        public virtual void ReadyStatusChanged()
        {
            ...
            foreach (NetworkRoomPlayerCustom item in roomSlots)
            {
                if (item != null)
                {
                    CurrentPlayers++;
    ...
    public struct steamIdMess : NetworkMessage
    {
        public ulong id;
    }
}
